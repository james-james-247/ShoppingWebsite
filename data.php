        ...
        <div class = "page">
            <div class = "page-wrapper">
                <header>
                    ...
                    <div class="navbar">
                        <ul>
                            ...
                            <li><a href="data.php" style="color: #40E0D0">Products</a></li>
                ...
                <div class="pageOpening">
                    <img src="Photos/dataBackground.jpg" class="pageMainImage">
                    <h1 class="pageMainText">Try Not To<br>Spend Too Much</h1>
                </div>
                <div class=pageContent>
                    <div id="dataArea">
                        <h3>Below Are Our Products You Can Purchase:</h3>
                        <p>Always the highest quality possible!</p>
                        <?php  
                            $servername = "localhost"; $username = "root"; $password = ""; $dbname = "n2s";
                            // Create connection
                            $conn = mysqli_connect($servername, $username, $password, $dbname);
                            $sql = "SELECT productID, productName, productURL, productYear, productPrice FROM products";
                            $result = mysqli_query($conn, $sql);
                            //Weve now created a loop that will run as many times as there are products in the database 
                            echo "<div id='outerDivs' style='padding-bottom: 20px'>";
                            while($row = $result->fetch_array()){
                                echo "<div class='createdDivs'><form action='userChange.php' method='POST'>";
                                echo "<h4 id='createdTitles'><a href='productPage.php?id=" . $row["productID"] . "'>". $row["productName"] ."</a></h4>";
                                echo "<img src=". $row["productURL"] ." id='createdImage'>";
                                echo "<h5 id='createdYear'>". $row["productYear"] ."</h5>";
                                echo "<p id='createdPrice'>£". $row["productPrice"] ."</p>";
                                echo "<input type='text' value=". $row["productID"] ." name='productName' hidden>";
                                echo "<input type='submit' value='Add To Basket' id='createdSubmit'>";
                                echo "</form></div>";
                            }
                            echo "</div>";
                            mysqli_close($conn);
