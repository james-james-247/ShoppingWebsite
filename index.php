        ...
        <div class = "page">
            <div class = "page-wrapper">
                <header>
                    ...
                    <div class="navbar">
                        <ul>
                            <li><a href="index.php" style="color: #40E0D0">Home</a></li>
                ...
                <div class="pageOpening">
                    <img src="Photos/indexBackground.jpg" class="pageMainImage">
                    <h1 class="pageMainText">A New Age <br>For Technology</h1>
                </div>
            </div>     
